    ...
    return Scaffold(
        ...
        child: Container(
          ...
          child: Center(
            child: ListTile(
              ...
              children: [
                TextSpan(text: "Bruno Cardoso", style: TextStyles.titleBoldBackground)
              ]
              ),),
      ...
      bottomNavigationBar: Container(
        ...
        child: Row(
          ...
          children: [
          IconButton(icon: Icon(Icons.home, color: AppColors.primary), onPressed: (){
          ...
          IconButton(icon: Icon(Icons.description_outlined, color: AppColors.body), onPressed: (){
